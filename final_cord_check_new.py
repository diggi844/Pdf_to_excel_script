...
# Computed per-page totals — not extracted from the PDF, so excluded from the
# extraction field set below (alongside Page/Status).
COMPUTED_COLUMNS = ("Page", "Status", "TOTAL_DARE", "TOTAL_AVERE", "TOTAL_SALDO")
